...
layout: essay
type: essay
title: "Short-term Issues; Long-term Problems"
...
<img width="1200px" height="800px" class="rounded float-start pe-4" src="../img/Estimation-Coding.png">
...
and recalling it later. In general, this pratice would often leave me to have relatively unusual estimates because I had wildly inaccurate historical data to work off of. Over time, I managed to actually write the down the time
or even set a timer on my phone, but this was still pretty inaccurate. In the future, I might use a professional timer app in order to hold myself accountable for my time management within long-term projects. I believe my tracking 
could be roughly estimated to have a margin of error of around thirty minutes. Overall, I still view this estimation process as a boon to the overall project because it was critical to recognizing the actual amount of work done to complete a given project.
Importantly, there were no AI tools used in this essay or for tracking as a result of personal preference. 
